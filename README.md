...
Stimulus a été créé par [Basecamp](https://basecamp.com/). C'est un framework de front, plus simple à prendre en main qu'Angular, React ou Vue. Il n'a pas été conçu pour rendre du HTML, mais pour l'augmenter.<br/>
...
## Si vous n'avez pas Rails ou d'éditeur de texte installés sur votre ordinateur/mac

Utilisez ce [tutoriel](https://github.com/women-on-rails/stimulus/blob/master/stimulus-sans-rails.md)
